...
if ($action== 'addlink') {
	...
	$Link_Model->addLink($linksortid, $sitename, $siteurl, $description, $taxis);
	$CACHE->updateCache(array('link','sortlink'));
...
if ($action=='update_link') {
	...
	$Link_Model->updateLink(array('linksortid'=>$linksortid, 'sitename'=>$sitename, 'siteurl'=>$siteurl, 'description'=>$description), $linkId);
